...
/*
this code is kind of ceaser cypher
but it needs to be entered a new alphabetical order
so it can encrypt text by mapping original letters to new alphabet
user entered
*/
